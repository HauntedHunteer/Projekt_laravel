...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="tlo">
        ...
        <div class="container">
            ...
            <form method="post" action="{{url('post-edycja')}}">
                ...
                <fieldset class="border p-2">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input class="form-control formularz" type="text" id="Imie" pattern="(^([A-ZĄĆĘŁŃÓŚŻŹ]){1})+[a-ząćęłńóśżź]*$" maxlength="15" required placeholder="Uzupełnij imie" name="forename" value="{{ $order->forename }}">
                        </div>
                        @error('forename')
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input class="form-control formularz" type="text" id="Nazwisko" pattern="(^([A-ZĄĆĘŁŃÓŚŻŹ]){1})+[a-ząćęłńóśżź]*$" maxlength="30" required placeholder="Uzupełnij nazwisko" name="name" value="{{ $order->name }}">
                        </div>
                        @error('name')
                        <div class="col-sm-8">
                            <span class="card-text kartyR">! {{ $message }} !</span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input class="form-control formularz" type="email" id="Mail" maxlength="100" required placeholder="Uzupełnij e-mail" name="email" value="{{ $order->email }}">
                        </div>
                        @error('email')
                        <div class="col-sm-8">
                            <span class="card-text kartyR">! {{ $message }} !</span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input class="form-control formularz" type="tel" id="Tel" pattern="[0-9]{3}-[0-9]{3}-[0-9]{3}" maxlength="11" required placeholder="Uzupełnij nr telefonu w postaci XXX-XXX-XXX" name="tel_number" value="{{ $order->tel_number }}">
                        </div>
                        @error('tel_number')
                        <div class="col-sm-8">
                            <span class="card-text kartyR">! {{ $message }} !</span>
                ...
                <fieldset class="border p-2">
                    ...
                    @if ($order->payments_methods == 'PayPal')
                    ...
                    @endif
                    @if ($order->payments_methods == 'DotPay')
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="payments_methods" id="Radio1" value="PayPal">
                        <label class="form-check-label formularz" for="Radio1">PayPal</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="payments_methods" id="Radio2" value="DotPay" checked>
                        <label class="form-check-label formularz" for="Radio2">DotPay</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="payments_methods" id="Radio3" value="Przelew">
                    ...
                    @endif
                    @if ($order->payments_methods == 'Przelew')
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="payments_methods" id="Radio1" value="PayPal">
                        <label class="form-check-label formularz" for="Radio1">PayPal</label>
                    </div>
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="payments_methods" id="Radio3" value="Przelew" checked>
                        <label class="form-check-label formularz" for="Radio3">Przelew</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="payments_methods" id="Radio4" value="Karta">
                    ...
                    @endif
                    @if ($order->payments_methods == 'Karta')
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="payments_methods" id="Radio1" value="PayPal">
                        <label class="form-check-label formularz" for="Radio1">PayPal</label>
                    </div>
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="payments_methods" id="Radio4" value="Karta" checked>
                        <label class="form-check-label formularz" for="Radio4">Karta</label>
                    </div>
                    @endif
                </fieldset>
                <fieldset class="border p-2">
                    ...
                    @enderror
                    <div class="col-sm-8">
                        <span class="card-text kartyN">Poprzednio wybrano:  {{ $order->products }} Wybierz ponownie </span>
                    </div>
                    ...
                    <br/>
                    <button type="submit" value="Submit" class="btn btn-primary przycisk1">Edytuj i Zamów</button>
                    <br/><p></p>
                    <div class="card-text kartytekst">
                        <a class="btn btn-primary btn-sm przycisk" href="{{url('zamowienia')}}">Anuluj</a>
                    </div>
                </fieldset>
            </form>
        </div>
